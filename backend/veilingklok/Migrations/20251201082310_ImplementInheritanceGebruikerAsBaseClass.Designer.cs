...
namespace veilingklok.Migrations
{
    ...
    [Migration("20251201082310_ImplementInheritanceGebruikerAsBaseClass")]
    partial class ImplementInheritanceGebruikerAsBaseClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("veilingklok.Aanvoerder", b =>
                {
                    b.HasOne("veilingklok.Gebruiker", null)
                        .WithOne()
                        .HasForeignKey("veilingklok.Aanvoerder", "GebruikerId")
            ...
            modelBuilder.Entity("veilingklok.Koper", b =>
                {
                    b.HasOne("veilingklok.Gebruiker", null)
                        .WithOne()
                        .HasForeignKey("veilingklok.Koper", "GebruikerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("veilingklok.Veilingmeester", b =>
                {
                    b.HasOne("veilingklok.Gebruiker", null)
                        .WithOne()
                        .HasForeignKey("veilingklok.Veilingmeester", "GebruikerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
